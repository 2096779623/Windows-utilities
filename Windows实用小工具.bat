...
@echo off
title Windows实用小工具 By 2096779623 v2.0.2.15
color 07
::编码为ANSI!!!
...
if %user_input% equ 13 slmgr /upk && slmgr /skms 192.168.1.98 && slmgr /ato
...
echo 102.禁止一联网就打开浏览器         112.文件/文件夹选项                       122.修复键盘映射
echo 103.启用无GUI引导(开机隐藏winlogo) 113.修改按下电源按钮时"无操作"            123.修复QQ登录蓝屏
echo 104.关闭SmartScreen应用筛选器      114.添加按住Ctrl,再按两次ScrollLock键蓝屏 124.清除IE收藏夹
