...
title Windows实用小工具 By Kevin Williams v2.0.2.22 本程序造成的一切后果由使用者承担，作者概不负责！Protected By AGPL-3.0 LICENSE！
color 07
cd /d "%~dp0"
...
IF "%tooldowntree%" EQU "" (set tooldowntree=%Temp%\Windows实用小工具)
echox -c 04 输入about查看关于界面
echox -c 04 输入next查看下一页
echox -c 04 输入setting进入设置页面
echo 输入exit退出
echo ========================================================================================================================================================================================================
...
echo ╚═════╝    ╚═╝       ╚══════╝ ╚═════╝  ╚════╝  ╚═════╝   ╚═╝     ╚═╝   ╚════╝  ╚═════╝ ╚══════╝╚═════╝
IF "%tooldowntree%" EQU "" (set tooldowntree=%Temp%\Windows实用小工具)
echox -c 04 "此脚本受GNU Affero General Public License v3.0协议的保护：https://github.com/2096779623/Windows-utilities/blob/main/LICENSE.md"
